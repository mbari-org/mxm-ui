  ...
  <q-page class="q-pa-md">
    ...
    >
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td key="updatedDate" :props="props" style="width: 5px">
            {{ props.row.updatedDate }}
          </q-td>

          <q-td key="missionStatus" :props="props" style="width: 5px">
            <q-chip dense size="sm">{{ props.row.missionStatus }}</q-chip>
          </q-td>

          <q-td key="missionTplId" :props="props" style="width: 5px">
            <router-link
              class="appLink"
              :to="
                utl.routeLoc([
          ...
          <q-td key="missionId" :props="props" style="width: 5px">
            <router-link
              class="appLink"
              :to="
                utl.routeLoc([
          ...
          <q-td key="providerMissionId" :props="props" style="width: 5px">
